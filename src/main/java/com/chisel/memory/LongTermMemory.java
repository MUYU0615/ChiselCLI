...
public class LongTermMemory implements Memory {
    ...
    private static final String STORAGE_DIR_PROPERTY = "chisel.memory.dir";
    private static final String STORAGE_DIR_ENV = "CHISEL_MEMORY_DIR";
    ...
    private static File resolveStorageDir() {
        ...
        return new File(new File(System.getProperty("user.home"), ".chisel"), "memory");
    }
