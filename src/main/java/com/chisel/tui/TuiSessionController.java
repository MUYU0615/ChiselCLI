...
import com.chisel.tui.pane.CenterPane;
import com.chisel.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final ChiselConfig config;
    ...
    public TuiSessionController(ChiselConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "chisel-tui-agent-runner");
