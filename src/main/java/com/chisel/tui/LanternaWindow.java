...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(ChiselConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("ChiselCLI v0.1.0");
