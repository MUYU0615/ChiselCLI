...
import com.chisel.tui.pane.FileTreePane;
import com.chisel.tui.pane.InputBar;
...
public class RootPane extends Panel {
     ...
     */
    public RootPane(ChiselConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.chisel/history/。");
            return true;
        }
