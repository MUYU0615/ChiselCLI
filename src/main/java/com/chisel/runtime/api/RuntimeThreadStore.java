...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("chisel.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("CHISEL_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".chisel", "runtime").toString();
        }
