    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[chisel] stdout reader stopped: " + e.getMessage());
            }
        }, "chisel-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[chisel] stderr reader stopped: " + e.getMessage());
            }
        }, "chisel-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
