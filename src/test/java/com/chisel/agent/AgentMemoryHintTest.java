...
import com.chisel.llm.GLMClient;
...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("chisel.memory.dir");
        System.setProperty("chisel.memory.dir", tempDir.toString());
        try {
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("chisel.memory.dir");
            } else {
                System.setProperty("chisel.memory.dir", oldMemoryDir);
            }
        }
    }
