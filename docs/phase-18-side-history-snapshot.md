...
新增包：`src/main/java/com/chisel/snapshot/`
...
```text
~/.chisel/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dchisel.snapshot.enabled=false
-Dchisel.snapshot.max=50
-Dchisel.snapshot.excludes=...
```
