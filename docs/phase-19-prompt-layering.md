...
```text
src/main/java/com/chisel/prompt/
...
2. 用户级覆盖：`~/.chisel/prompts/...`
3. 项目级覆盖：`.chisel/prompts/...`

例如：

```text
~/.chisel/prompts/base.md
~/.chisel/prompts/modes/agent.md
.chisel/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.chisel/prompts/...`
- [x] 支持项目级覆盖 `.chisel/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
